...
public class WithdrawFlowTC extends BaseTest{
	...
	public void verifyWalletAmount() throws InterruptedException, IOException, ParseException {
		...
		if (onFpUI.equals(onBackend)) {
		    test.pass("Available Balance on Backend : " + onBackend +"  |  " + "Wallet Balance on UI : " + onFpUI);
		} else {
		    test.fail("Wallet Balance value not matched as on backend");
		}
	}
